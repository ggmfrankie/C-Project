...
namespace Obj {
    ...
    void PhysicsObject::resolveCollision(PhysicsObject &other, const ggm::Vector3f &normal, const float penetration, const ggm::Vector3f &contactPoint) {
        using namespace ggm;
    ...
    void PhysicsObject::computeInertiaTensor() {
    ...
    void PhysicsObject::update(const double dt, Render::Input& input) {
        if (dirty) {
            updateColliders();
            updateInertiaWorld();
        }
    ...
    void PhysicsObject::updateInertiaWorld() {
    ...
    void PhysicsObject::rotateBy(const ggm::Vector3f& v){
        Object::rotateBy(v.x, v.y, v.z);
        dirty = true;
    }
    ...
    void PhysicsObject::applyForce(const ggm::Vector3f& force) {
        forces += force;
    }
